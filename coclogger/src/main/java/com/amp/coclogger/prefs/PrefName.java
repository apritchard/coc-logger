...
public enum PrefName {
	...
	TEXT_X("text-x", PrefType.INTEGER, 0, true),
	TEXT_Y("text-y", PrefType.INTEGER, 0, true),
	TEXT_WIDTH("text-width", PrefType.INTEGER, 1, true),
	TEXT_HEIGHT("text-height", PrefType.INTEGER, 1, true),
	...
	ENEMY_LEAGUE_X("enemy-league-x", PrefType.INTEGER, 0, true),
	ENEMY_LEAGUE_Y("enemy-league-y", PrefType.INTEGER, 0, true),
	ENEMY_LEAGUE_WIDTH("enemy-league-width", PrefType.INTEGER, 1, true),
	ENEMY_LEAGUE_HEIGHT("enemy-league-height", PrefType.INTEGER, 1, true),
