...
/**
 * Took from
 * https://github.com/pclubiitk/ocr-native/blob/master/Binarization.java
 *
 */
public class Binarization {
	...
	public static BufferedImage getBinarizedImage(BufferedImage original){
		return binarize(toGray(original));
	}
	...
	private static void writeImage(String output, String part)
			throws IOException {
	...
	private static BufferedImage binarize(BufferedImage original){
		return binarize(original, otsuThreshold(original));
	}
